...
namespace CodeFlow.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult GetTheCode()
        {
            ...
            const string State = "ThiIsMyStateVAlue";
                ...
                string code, string state)
        {
            ...
            //con fines de mostrar pero debe ser oculto el access token
            var PrettyPrintJsonContent = JsonSerializer.Serialize(JsonContent,
